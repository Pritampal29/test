    ...
    <div class="container" id="image-gallery">
      ...
      if ($total_data > $limit) { ?>
            <div id="load-more-wrapper">
                <button id="load-more-images" data-offset="<?php echo $limit; ?>" class="btn btn-primary my-3">Load
                    More</button>
            </div>
            <div id="load-less-wrapper" style="display:none;">
                <button id="load-less-images" data-limit="<?php echo $limit; ?>" class="btn btn-primary my-3">Load
                    Less</button>
            </div>
            <?php } ?>
        </div>
